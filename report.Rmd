...
We have identified some relevant variables in the variable importance part, the two most important ones are manufacturertelsa and year. The next step is to attempt to understand how the
...
```{r}
pdp1.rf <- xgb.fit %>%
  partial(pred.var = c("manufacturertelsa")) %>%
