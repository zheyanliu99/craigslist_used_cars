...
p2 =
  imp_tree_df %>% 
      ...
      geom_bar(stat="identity") + theme(legend.position="none",axis.text.x = element_text(angle = 30)) + labs(x="variable", y = 'importance')
...
p3 = 
  imp_gbm_df %>% 
      ggplot(aes(x=reorder(variable, -coefficients, median, na.rm = TRUE), y=coefficients, fill=positive)) +
      geom_bar(stat="identity") + theme(legend.position="none",axis.text.x = element_text(angle = 30)) + 
